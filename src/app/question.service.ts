  ...
  name = "";
	...
	questions = 
  	[
        ...
        "After becoming proficient in shooting, you enter your first village-looting mission. While ravaging through villagers' possession, a child appears on the street. The commander orders you to shoot him. What do you to?",
        "After two years being in the rebel army, you get sent on a bus that landed in a rehabilitation centre in Freetown. You start having nightmares about drug-induced killing sprees. Just as you begin to move past that chapter of your life, you receive an invitation to travel to the US to recount your story. Do you accept it?",
      ...
      [
        ...
        "A boy soldier about your age uses a machete to cut off both your hands and leaves you to die on the ground. You wake up hungry, weak, and most importantly, lost as to where the hospital is. After a few hours of walking, you see a man in uniform nearby. What do you do?",
        "Luckily, he is not a rebel. You receive direction to the nearest hospital and proceed towards that direction. When you ask for assistance at a village near the hospital, two women harshly tell you to get lost, thinking you are rebels' bait. What do you do?",
        ...
        "Your child dies of malnutrition a few days later which becomes a permanent trauma. Some children in the amputees' camp begin begging for additional money but you find it distasteful. Do you join them?",
  ...
  results = 
    [
      [
        ...
        "After a few months, you exit the rehabilitation centre and move in with your uncle's family. As Freetown soon gets invaded by the rebel, you escape with them to another village.",
        "You leave with your uncle's family and settle down in a small village with his family. You soon get married and become the breadwinner of the family.",
      ...
      [
        "The soldier shoots you from the back. You die while seeing your home burn to the ground.",
        "He shakes his head disapprovingly and another soldier proceeds to shoot you.",
        ...
        "Unsanitary equipment combined with the previous performance of female genital mutilation cause you to die painfully on the operation table.",
